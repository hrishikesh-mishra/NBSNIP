<?php
/**
 * @version		$Id: english.php 2009-01-01 15:24:18Z $
 ...
 * BlastChat Client is free software. This version may have been modified pursuant
...
//New in version 3.0
if (!defined('_BC_URL')) DEFINE('_BC_URL','Url');
if (!defined('_BC_URL_DES')) DEFINE('_BC_URL_DES','Your website URL');
if (!defined('_BC_INTRAID')) DEFINE('_BC_INTRAID','Intra id');
if (!defined('_BC_INTRAID_DES')) DEFINE('_BC_INTRAID_DES','Unique website identificator. If empty or lost, register your website and retrieve it from blastchat.com');
if (!defined('_BC_PRIVKEY')) DEFINE('_BC_PRIVKEY','Private key');
if (!defined('_BC_PRIVKEY_DES')) DEFINE('_BC_PRIVKEY_DES','Your website private key. Do not share this information, used for security purposes. If empty or lost, register your website and retrieve it from blastchat.com');
//Changed in version 3.0
	if (!defined("_BC_CHATTING")) DEFINE("_BC_CHATTING", " chatting"); //added missing space in from of the word
