...
<div class="vehicle" id="vehicleid">
<table width="100%"  border="1" bordercolor="#00CC00">
  <tr>
    <td width="67%" rowspan="3" valign="center" align="center" bordercolor="#00CC00"><font face="Geneva, Arial, Helvetica, sans-serif" size="4"  color="#660000">Vehicle Classifieds</font></td>
...
<?php
	...
	for ($i=0, $n=count($this->vehicle); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_classifieds&controller=vehicle&task=info&row='. $row->id );
