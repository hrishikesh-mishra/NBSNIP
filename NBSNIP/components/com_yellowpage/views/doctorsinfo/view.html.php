<?php
	...
	*/
	...
	class yellowPageViewDoctorsInfo extends JView 
	{
		...
		function display($tpl = null)
		{
			...
			$sess->set('scode',$text,'doctors');


			$doctors[0]->image =JHTML::_('image','/components\com_yellowpage\assets\captcha.php?scode='.$text,'myimage');
