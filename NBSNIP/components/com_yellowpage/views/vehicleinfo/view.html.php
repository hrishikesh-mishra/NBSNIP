<?php
	...
	*/
	...
	class yellowPageViewVehicleInfo extends JView 
	{
		...
		function display($tpl = null)
		{
			...
			$sess->set('scode',$text,'vehicle');


			$vehicle[0]->image =JHTML::_('image','/components\com_yellowpage\assets\captcha.php?scode='.$text,'myimage');
