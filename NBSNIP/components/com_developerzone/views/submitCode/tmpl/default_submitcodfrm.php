...
var err=new String();
	...
	err += FRMnonBlank("description" , "Description");
	err += FRMnonBlank("cfile" , "Code-File");
...
<td><IMG height=80 src="components/com_developerzone/assets/devbase/devbase_08.gif" width=37 border=0></td>
	...
	<td  height="100" colspan="2"> 
	 <font face="Geneva, Arial, Helvetica, sans-serif" size="5" color="#0033FF"><strong>SUBMIT CODE </strong></font>
	...
	?>	</div>
	 ...
	 <tr><td align="left" valign="top"><font face="Geneva, Arial, Helvetica, sans-serif" size="2" color="#9900CC"><strong>Code-File</strong></font></td> 
	   <td><input type="file" id="cfile" name="cfile" size="32"	readonly="readonly" /><br/>
	   		<font face="Geneva, Arial, Helvetica, sans-serif" size="1" color="#FF0000"><strong>File type Should be Zip only.<br/>And Maximum Size=5 MB</strong></font></td>
    </tr>	
...
<input type="hidden" name="task" value="submitCode" />
</form>
  </table>  
</div>
