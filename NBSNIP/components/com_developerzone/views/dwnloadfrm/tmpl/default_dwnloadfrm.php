...
<td><IMG height=80 src="components/com_developerzone/assets/devbase/devbase_08.gif" width=37 border=0></td>
	...
	<td width="50%" height="100"> 
	 <font face="Geneva, Arial, Helvetica, sans-serif" size="5" color="#0033FF"><strong>Code Download Manger</strong></font>
	...
	?></div>
	  ...
	  <form method="post" id="searchdownload" name="searhdownload" onsubmit="return FRMvalidate();">
        <table  border="0">
		    <tr colspan="">
	...
	<input type="hidden" name="task" value="dwnldsearch" >
	</form>
      </div></td>      
    </tr>
    <tr>
