...
<form name="logform" id="logform" method="post" >
  ...
  <tr>
 <td width="0"/>
  <td colspan="2" align="center" height="30"> <b><font face="Verdana, Arial, Helvetica, sans-serif" size="4" color="#00FFFF"> Member Login  </font></b> </td>
  <td width="14"/>
  </tr>
  
  <tr>
  <td width="0"/>
    <td width="110"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#FFFF00"><strong>Memeber Id :<strong></font></td>
    <td width="180" align="left"><input type="text" name="userid" id="userid" size="10" maxlength="20"/> </td>
   <td width="14"/>
   </tr>
   <tr>
   <td width="0"/>
   <td width="110"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#FFFF00"><strong>Password :</strong></font></td>
   <td width="180" align="left"><input type="password" name="password"  id="password" size="10" maxlength="20"/></td>
   <td width="14"/>
   </tr>
   <tr>
   <td width="0"/>
...
<input type="hidden" name="task" value="login" >
   ...
   <tr>
   <td width="0"/>
   <td colspan="2" align="center"><a href ='<?php echo JRoute::_("index.php?option=com_matrimonial&task=frgpwd", false); ?>'><font color="#CC0033"><strong>Forget Password ?</strong></font></a></td>
   <td width="14"/>
   </tr>
</table>
...
<td width="201">
<a href="<?php echo JRoute::_('index.php?option=com_matrimonial&task=regform'); ?>" ><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#FF0033"><strong>Registration:</strong></font></a></td>
<td width="36" />
</tr>
</table>
</div>
