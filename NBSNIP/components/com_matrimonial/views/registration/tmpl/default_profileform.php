...
echo "<strong> Welcome <em>" .$this->data['userid']."</em></strong>"; ?>
...
function validatForm()
{
	...
	if (form.userid.value=="" || form.username.value=="" || form.password.value=="" || form.cpassword.value=="" || form.emailid.value=="" )
		err +='Matrimonial Account infomation is invalid. <br/>';
...
<form name="profile" id="profile" method="post"  enctype="multipart/form-data" onsubmit="return validatForm();" onkeyup="checksize()"> 
<div id="pcreate">
  <table width="100%" border="0">
    <tr>
      <td colspan="2"><li><font face="Geneva, Arial, Helvetica, sans-serif" size="4" color="#FF0000"><strong> Create Profile </strong></font></li>
        <li>Enter information of the person looking to get married. </li>
	  <li>Enter accurate detail to  get better response.	  </li>
	  </p>
	  <hr/></td>
    </tr>
    <tr>
    <td colspan="2"> <div id="errtext" name="errtext" class="errtext"></div></td>
    </tr>

    <tr>
      <td colspan="2"><strong><em>Your Profile Detail</em></strong> </td>
    </tr>
    <tr>
      <td width="20%" height="26" align="left" valign="top">Profile Create By</td>
      <td width="80%" align="left" valign="top"><strong>:</strong>        <select name="pcby" id ="pcby"><option  selected value="self">Self</option><option value="Parent_Guradian">Parent_Guradian</option><option value="sibling"> Sibling</option><option value="friend">Friend</option><option value="other">Other </option></select>      </td>
    </tr>
    ...
    <tr>
      ...
      <td align="left" valign="top"><strong>:</strong>
		...
		<option value="165" selected>5ft 5in - 165cm</option>
    ...
    <tr>
      <td height="26" colspan="2"><hr/></td>
    </tr>
    <tr>
      <td height="26" align="left" valign="top">Education</td>
      <td height="26" align="left" valign="top"><strong>:
    ...
    <tr>
      ...
      <td height="26" align="left" valign="top"><strong>:
          <textarea name="about" id="about" rows="5" cols="60" ></textarea>
	  <br/>
	  <p>Character Typed :<input type="text" name="ctype" id="ctype" size="3" readonly="readonly"/> (minimum: 100 character) </p>
    ...
    <tr>
      <td height="26" colspan="2"><strong><em>Matrimonial Account Infomation</em></strong>: </td>
    </tr>
    <tr>
      <td height="26" align="left" valign="top">User-ID</td>
      <td height="26" align="left" valign="top"><strong>:
        <input type="text" name="userid" id="userid" size="32" maxlength="50" readonly="readonly" value="<?php 
...
?>"/>
    ...
    <tr>
      <td height="26" align="left" valign="top">Name</td>
      <td height="26" align="left" valign="top"><strong>:
        <input type="text" name="username" id="username" size="32" maxlength="50" readonly="readonly" value="<?php 
...
?>"/>
    ...
    <tr>
      <td height="26" align="left" valign="top">Password</td>
      <td height="26" align="left" valign="top"><strong>:
        <input type="password" name="password" id ="password" size="32" maxlength="50"  readonly="readonly" value="<?php 
...
?>"/>
    ...
    <tr>
      <td height="26" align="left" valign="top">Confirm-Password</td>
      <td height="26" align="left" valign="top"><strong>:
        <input type="password" name="cpassword"  id="cpassword" size="32" maxlength="50" readonly="readonly" value="<?php 
...
?>"/>
    ...
    <tr>
      <td height="26" align="left" valign="top">Email-ID</td>
      <td height="26" align="left" valign="top"><strong>:
        <input type="text" name="emailid" id="emailid" size="32" maxlength="200"  readonly="readonly" value="<?php 
...
?>"/>
    ...
    <tr align="left" valign="top">
      <td height="26" colspan="2"><strong><em>Looking for:</em></strong> </td>
    </tr>
    <tr>
      <td height="26" align="left" valign="top">Height</td>
      <td height="26" align="left" valign="top"><strong>:
		...
		<option value="5ft 5in - 165cm" selected>5ft 5in - 165cm</option>
    ...
    <tr>
      ...
      <td height="26" align="left" valign="top"><strong>:
        ...
        <textarea name="lfotherrequirement" id="lfotherrequirement" rows="5" cols="55"></textarea>
      </strong></td>
    </tr>
	<tr>
    ...
    <tr>
      ...
      <td height="31" align="left" valign="top"><table width="45%" border="0">
        <tr>
