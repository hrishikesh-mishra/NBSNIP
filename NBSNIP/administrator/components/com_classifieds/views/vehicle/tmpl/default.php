...
<div id="editcell">
	...
	for ($i=0, $n=count($this->vehicle); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_classifieds&controller=vehicle&task=edit&cid[]='. $row->id );
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit Vehicle' );?>::<?php echo $row->title; ?>">
