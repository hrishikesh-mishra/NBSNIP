...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th>
				<?php echo JText::_('Last Visited IP'); ?>
			</th>
	...
	for ($i=0, $n=count($this->user); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_socialnetworking&controller=user&task=edit&cid[]='. $row->id );
