<?php
 ...
 /* 
	Social Networking User Controller
...
defined('_JEXEC') or die ('Ristricted Access ');
 ...
 class socialnetworkingControllerUser extends JController
 {
	...
	function edit()
	 ...
	 function save()
	 {
		...
		$this->setRedirect('index.php?option=com_socialnetworking&controller=user', $message );
	 }
	...
	function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_socialnetworking&controller=user', $msg );
	}
	...
	function mail()
	{
		...
		echo $data->userid;
			...
			$view = new socialnetworkingViewUserEmail();
	...
	function sendmail()
	{
		...
		$this->setRedirect( 'index.php?option=com_socialnetworking&controller=user','' );
