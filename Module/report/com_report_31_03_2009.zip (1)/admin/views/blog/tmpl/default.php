...
<div>
  <table width="100%" border="0">
    <tr>
      ...
      <td colspan="2" align="center" valign="middle"><font size="+2" color="#0000CC" face="Times New Roman, Times, serif"><strong>Blogging Report</strong></font></td>
      <td width="15%">&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td colspan="2"><a href="<?php echo JRoute::_('index.php?option=com_report&controller=blog&task=allUserRpt&format=pdf',false); ?>" style="text-decoration:none"><font size="2" face="Times New Roman, Times, serif" color="#990000"><strong>All User Report </strong></font></a></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td colspan="2"><font size="2" face="Times New Roman, Times, serif" color="#990000"><strong>User Profile Report </strong></font></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
	...
	<input type="hidden" id="controller" name="controller" value="blog" />
	<input type="hidden" id ="task" name="task" value="userBlgRpt" />
