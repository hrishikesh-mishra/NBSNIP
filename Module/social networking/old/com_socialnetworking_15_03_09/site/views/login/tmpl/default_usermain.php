...
<div id="divusermain">
  <table width="100%" border="0" cellpadding="5" cellspacing="0">
    <tr>
      <td height="67" colspan="5" align="left" valign="middle"><p><font size="+3" color="#FF00FF" face="Arial, Helvetica, sans-serif" ><strong>Welcome User - <?php echo $LogUserID; ?></strong></font></p>
      </td>
    </tr>
	<tr>
	<td><div id="errtext" name="errtext" class="errtext">
