<?php 
	/*
	  yellowpage education add layout 
	*/
...
<script language="javascript" type="text/javascript">
		function submitbutton() {
			...
			{
				alert( "<?php echo JText::_( 'You must provide a Cateogry of Education.', true ); ?>" );
				return false;
			}
...
<div>
  <table width="100%" border="5">
    <tr>
      <td height="36" colspan="2" align="center"><strong>Add Education YellowPage Information </strong></td>
    </tr>
    <tr>
      <td width="18%" height="23" align="right">Education Name: </td>
      <td width="82%" align="left"><input type="text" name="eduname" id="eduname" size="32" maxlength="100" value="" class="inputbox required" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="23" align="right">Standard:</td>
      <td height="23" align="left"><input type="text" name="standard" id="standard" size="32" maxlength="250" value="" /></td>
    </tr>
    <tr>
      <td height="23" align="right">Principal:</td>
      <td height="23" align="left"><input type="text" name="principal" id="principal" size="32" maxlength="200" value="" class="inputbox required"/></td>
    </tr>
    <tr>
      <td height="23" align="right">Total Strength: </td>
      <td height="23" align="left"><input type="text" name="totalstrength" id="totalstrength" size="10" maxlength="7" value="" /></td>
    </tr>
    <tr>
