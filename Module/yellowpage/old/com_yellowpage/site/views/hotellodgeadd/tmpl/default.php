<?php 
	/*
	  yellowpage Hotel-Lodge add layout 
	*/
...
<script language="javascript" type="text/javascript">
		function submitbutton() {
			...
			{
				alert( "<?php echo JText::_( 'You must provide a Cateogry of Hotel-Lodge.', true ); ?>" );
				return false;
			}
...
<div>
  <table width="100%" border="5">
    <tr>
      <td height="36" colspan="2" align="center"><strong>Add Hotel-Lodge YellowPage Information </strong></td>
    </tr>
    <tr>
      <td width="18%" height="23" align="right">Hotel-Lodge Name: </td>
      <td width="82%" align="left"><input type="text" name="hotelname" id="hotelname" size="32" maxlength="100" value="" class="inputbox required" /></td>
    </tr>
    <tr>
