<?php 
	...
	*/
	...
	switch ($row->params->get('club_icons'))
		{
			case 1 :
				$row->params->set('club_address', 	JText::_('Address').": ");
				$row->params->set('club_email', 		JText::_('Email').": ");
				$row->params->set('club_phone', 	JText::_('Telephone').": ");
				$row->params->set('club_mobile',		JText::_('Mobile').": ");
				break;

			case 2 :
				$row->params->set('club_address', 	'');
				$row->params->set('club_email', 		'');
				$row->params->set('club_phone', 	'');
				$row->params->set('club_mobile', 	'');
				break;
			...
			default :
				...
				$row->params->set('club_address', 	$image1);
				$row->params->set('club_email', 	$image2);
				$row->params->set('club_phone', 	$image3);
				$row->params->set('club_mobile', 	$image4);
...
<div class="clubinfo" id="club"></div>
<table width="100%" border="0">

  <tr height="20%">
    <td colspan="3" align="center"><strong>Club YellowPage </strong></td>
  </tr>
  <tr>
    <td colspan="3" align="left"><strong> <?php echo JText::_($row->clubname); ?> </strong></td>
  </tr>
  
  <?php if ( $row->params->get( 'show_secretaryname' ) &&  $row->secretaryname) : ?>
  <tr height="20">
    <td width="16%" align="right">Secretary Name : </td>
    <td colspan="2" align="left"><?php echo JText::_($row->secretaryname); ?>  </td>
  </tr>
  <?php endif; ?>

 <?php if ( $row->params->get( 'show_history' ) &&  $row->history) : ?>
  <tr height="20">
    <td align="right">History of Club : </td>
    <td colspan="2" align="left"><?php echo JText::_($row->history); ?> </td>
  </tr>
  <?php endif; ?>

<?php if ( $row->params->get( 'show_sportactivity' ) &&  $row->sportactivity ) : ?>
  <tr height="20">
    <td align="right">Sport-Activity : </td>
    <td colspan="2" align="left"><?php echo JText::_($row->sportactivity); ?> </td>
  </tr>
<?php endif; ?>

<?php if ( $row->params->get( 'show_secretaryword' ) &&  $row->secretaryword ) : ?>
  <tr height="20">
    <td align="right">Secretary Word: </td>
    <td colspan="2" align="left"><?php echo JText::_($row->secretaryword); ?></td>
  </tr>
  <?php endif;?>
  
<?php if ( $row->params->get( 'show_phone' ) &&  $row->phone ) : ?>
<tr height="20">
    <td align="right"><?php echo $row->params->get( 'club_phone' ); ?> : </td>
...
<?php endif; ?>
 ...
 <?php if ( $row->params->get( 'show_mobile' ) &&  $row->mobile ) : ?>
  <tr height="20">
    <td align="right"><?php echo $row->params->get( 'club_mobile' ); ?> : </td>
...
<tr><td>&nbsp;</td> </tr>
  <tr>
    <td colspan="3" align="right"><table width="100%" border="0">
      <tr>
        <td width="16%" rowspan="3" align="right" valign="top"><?php echo $row->params->get( 'club_address' ); ?></td>
  ...
  <tr height="20">
    <td align="right"><?php echo $row->params->get( 'club_email' ); ?> : </td>
