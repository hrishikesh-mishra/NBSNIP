...
<form action="index.php" method="post" name="emailForm" id="emailForm" class="form-validate">
  ...
  <tr>
    <td height="404" colspan="2" align="left"><table width="100%" border="0">
      ...
      <tr>
        <td height="24" align="right"><?php echo $this->medical[0]->image ; ?>
<br /></td>
	...
	<?php if ($this->medical[0]->params->get('show_email_copy')) : ?>
...
<input type="hidden" name="id" value="<?php echo $this->medical[0]->id ;?>" />
