...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th width="20">
				<input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo count( $this->medical); ?>);" />
			</th>			
			<th>
	...
	for ($i=0, $n=count($this->medical); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_yellowpage&controller=medical&task=edit&cid[]='. $row->id );
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit Medical' );?>::<?php echo $row->medname; ?>">
				<a href="<?php echo $link; ?>"><?php echo $row->medname; ?></a>
			</td>
			<td>
