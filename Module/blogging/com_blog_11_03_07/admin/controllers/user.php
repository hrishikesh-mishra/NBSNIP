...
defined('_JEXEC') or die ('Ristricted Access ');
 ...
 class blogControllerUser extends JController
 {
	...
	function edit()
	 ...
	 function save()
	 {
		...
		$this->setRedirect('index.php?option=com_blog&controller=user', $message );
	 }
	...
	function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_blog&controller=user', $msg );
	}
	...
	function sendmail()
	{
		...
		$this->setRedirect( 'index.php?option=com_blog&controller=user','' );
