...
<form name="editprofile" id="editprofile" method="post"  enctype="multipart/form-data" onsubmit="return validatForm();" onkeyup="checksize()"> 
<div id="pcreate">
  <table width="100%" border="0">
    ...
    <tr>
      ...
      <td width="46%" rowspan="11" align="left" valign="top"><input type="image" name="imageField" 
      src="components/com_matrimonial/assets/photos/<?php
		if($this->data->image)
		    echo $this->data->image; 
		else
		    echo 'blnkphotogif.gif';	
		?>" height="250" width="300"></td>
    ...
    <tr>
      ...
      <td height="26" colspan="3" align="left" valign="top"><strong>:
		  ...
		  value="<?php 
					if($this->data->specificdegree)
						echo $this->data->specificdegree ;
					?>"/>
      </strong></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td height="26" colspan="3" align="left" valign="top"><strong>:
        ...
        <textarea name="lfotherrequirement" id="lfotherrequirement" rows="5" cols="55"><?php 
			if ($this->data->lfotherrequirement)
				echo $this->data->lfotherrequirement;
			?></textarea>
      </strong></td>
    </tr>
	<tr>
    ...
    <tr>
      ...
      <td height="31" colspan="3" align="left" valign="top"><table width="45%" border="0">
        <tr>
...
<input type="hidden" name="task" value="editprf" >
