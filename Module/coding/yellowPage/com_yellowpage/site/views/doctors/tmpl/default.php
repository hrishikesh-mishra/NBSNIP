<?php 
	...
	*/
	...
	$link = JRoute::_( 'index.php?option=com_yellowpage&controller=doctors&task=add');
...
<div class="doctors" id="doctors">
 <table width="100%" border="2">
  <tr>
    <th height="23" colspan="2" align="center" scope="col">Doctors YellowPage </th>
  </tr>
  <tr>
    <td width="43%" height="114">Doctors YellowPage provides the information regarding doctors.
	You can also add doctors details here. <a href="<?php echo $link ; ?> " >Add </a></td>
  ...
  <tr >
    ...
    <td height="60" colspan="2"><table width="100%" border="0">
      ...
      <tr height="30">
        <th width="78%" align="left" bgcolor="#00CCFF" scope="col">Doctors YellowPage </th>
...
<?php
	...
	for ($i=0, $n=count($this->doctors); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_yellowpage&controller=doctors&task=info&row='. $row->id );
	...
	?>
		<tr class="<?php echo "row$k"; ?>" bgcolor="<?php echo $bcolor ;?>" height="20" >
			...
			<td align="left" ><a href="<?php echo $link; ?>"><?php echo $row->docname; ?> </a>
			</td>
