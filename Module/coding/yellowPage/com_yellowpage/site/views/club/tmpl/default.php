<?php 
	...
	*/
	...
	$link = JRoute::_( 'index.php?option=com_yellowpage&controller=club&task=add');

	?>

<form  method="post" name="adminForm" id="adminForm" >
<div class="club" id="clubid">
 <table width="100%" border="2">
  <tr>
    <th height="23" colspan="2" align="center" scope="col">Club YellowPage </th>
  </tr>
  <tr>
    <td width="43%" height="114">Club YellowPage provides the information 
regarding about the clubs. Here You can also add your club information.<a href="<?php echo $link ; ?> " >Add </a></td>
  ...
  <tr >
    ...
    <td height="60" colspan="2"><table width="100%" border="0">
      ...
      <tr height="30">
        <th width="78%" align="left" bgcolor="#00CCFF" scope="col">Club YellowPage </th>
...
<?php
	...
	for ($i=0, $n=count($this->club); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_yellowpage&controller=club&task=info&row='. $row->id );
	...
	?>
		<tr class="<?php echo "row$k"; ?>" bgcolor="<?php echo $bcolor ;?>" height="20" >
			...
			<td align="left" ><a href="<?php echo $link; ?>"><?php echo $row->clubname; ?> </a>
			</td>
