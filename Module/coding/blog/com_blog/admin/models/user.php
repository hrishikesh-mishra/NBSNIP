...
defined('_JEXEC') or die ('Ristricted Access ');
	...
	class blogModelUser extends JModel
	{  
	...
	function save ($data)
	{
		...
		if (empty($pwd))
		{
			$query="select password from #__blog_user where id='" .$data['id'] ."'";
	...
	function getTotal()
	{
		...
		{
			$this->_total = $this->_getListCount("select * from #__blog_user");
		}
		return $this->_total;
	}
