...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th width="20">
				<input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo count( $this->tea); ?>);" />
			</th>			
			<th>
	...
	for ($i=0, $n=count($this->tea); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_classifieds&controller=tea&task=edit&cid[]='. $row->id );
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit Tea' );?>::<?php echo $row->title; ?>">
