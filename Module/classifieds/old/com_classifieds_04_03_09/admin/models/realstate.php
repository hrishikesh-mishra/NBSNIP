...
defined('_JEXEC') or die ('Ristricted Access ');
	...
	function save ($data, $params)
	{
		...
		$row =& JTable::getInstance('realstate','Table');
	...
	function getTotal()
	{
		...
		{
			$this->_total = $this->_getListCount("select * from #__cf_realstate");
		}
		return $this->_total;
	}
	...
	function changeRealstate( $cid=null, $state=0 )
	{
