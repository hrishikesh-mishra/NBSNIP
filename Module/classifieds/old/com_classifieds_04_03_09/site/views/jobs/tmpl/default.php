...
<div class="jobs" id="jobsid">
<table width="100%"  border="1" bordercolor="#00CC00">
  <tr>
    <td width="67%" rowspan="3" valign="center" align="center" bordercolor="#00CC00"><font face="Geneva, Arial, Helvetica, sans-serif" size="4"  color="#660000">Jobs Classifieds</font></td>
  ...
  <tr>
    <td  colspan="3"><table width="100%" height="100%" border="0">
      <tr >
        <td width="79%" height="30" align="left" bordercolor="#ECE9D8" bgcolor="#FF99FF"><font color="#006600" > <strong> Jobs</strong></font></td>
...
<?php
	...
	for ($i=0, $n=count($this->jobs); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_classifieds&controller=jobs&task=info&row='. $row->id );
