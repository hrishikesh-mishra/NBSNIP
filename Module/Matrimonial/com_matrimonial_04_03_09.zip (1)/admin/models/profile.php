...
defined('_JEXEC') or die ('Ristricted Access ');
	...
	class matrimonialModelProfile extends JModel
	{  
	...
	function &getProfile()
	{
		...
		if(empty($this->_data))
		{
			$query = "select * from #__mat_profile "; 
	...
	function getTotal()
	{
		...
		{
			$this->_total = $this->_getListCount("select * from #__mat_profile");
		}
		return $this->_total;
	}
