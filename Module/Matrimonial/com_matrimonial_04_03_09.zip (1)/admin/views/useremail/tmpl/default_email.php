...
<div class="col width-70" >
	<fieldset class="adminform">
		...
		<tr>
			...
			<td >
				<input type="text" class="text_area" readonly="readonly"  name="username" id="username" size="32" maxlength="90" value="<?php echo $this->data->username;?>" /> 
			</td>
		</tr>
		<tr>
			<td class="key">
			...
			<td >
				<input class="text_area" type="text" name="emailid" id="emailid" readonly="readonly" value="<?php echo $this->data->emailid;?>" /> 
			</td>
		</tr>
