...
--
-- Definition of table `blog_comment`
--
...
--
-- Definition of table `cf_computer`
--

DROP TABLE IF EXISTS `cf_computer`;
...
--
-- Dumping data for table `cf_computer`
--

/*!40000 ALTER TABLE `cf_computer` DISABLE KEYS */;
/*!40000 ALTER TABLE `cf_computer` ENABLE KEYS */;
...
INSERT INTO `jos_banner` (`bid`,`cid`,`type`,`name`,`alias`,`imptotal`,`impmade`,`clicks`,`imageurl`,`clickurl`,`date`,`showBanner`,`checked_out`,`checked_out_time`,`editor`,`custombannercode`,`catid`,`description`,`sticky`,`ordering`,`publish_up`,`publish_down`,`tags`,`params`) VALUES 
 ...
 (3,1,'','Joomla!','joomla',0,977,0,'','http://www.joomla.org','2006-05-29 14:21:28',1,0,'0000-00-00 00:00:00','','<a href=\"{CLICKURL}\" target=\"_blank\">{NAME}</a>\r\n<br/>\r\nJoomla! The most popular and widely used Open Source CMS Project in the world.',14,'',0,1,'0000-00-00 00:00:00','0000-00-00 00:00:00','',''),
 (4,1,'','JoomlaCode','joomlacode',0,977,0,'','http://joomlacode.org','2006-05-29 14:19:26',1,0,'0000-00-00 00:00:00','','<a href=\"{CLICKURL}\" target=\"_blank\">{NAME}</a>\r\n<br/>\r\nJoomlaCode, development and distribution made easy.',14,'',0,2,'0000-00-00 00:00:00','0000-00-00 00:00:00','',''),
 (5,1,'','Joomla! Extensions','joomla-extensions',0,972,0,'','http://extensions.joomla.org','2006-05-29 14:23:21',1,0,'0000-00-00 00:00:00','','<a href=\"{CLICKURL}\" target=\"_blank\">{NAME}</a>\r\n<br/>\r\nJoomla! Components, Modules, Plugins and Languages by the bucket load.',14,'',0,3,'0000-00-00 00:00:00','0000-00-00 00:00:00','',''),
 (6,1,'','Joomla! Shop','joomla-shop',0,972,0,'','http://shop.joomla.org','2006-05-29 14:23:21',1,0,'0000-00-00 00:00:00','','<a href=\"{CLICKURL}\" target=\"_blank\">{NAME}</a>\r\n<br/>\r\nFor all your Joomla! merchandise.',14,'',0,4,'0000-00-00 00:00:00','0000-00-00 00:00:00','',''),
 (7,1,'','Joomla! Promo Shop','joomla-promo-shop',0,5673,2,'','http://shop.joomla.org','2009-02-12 12:43:48',1,0,'0000-00-00 00:00:00','','',33,'',0,3,'0000-00-00 00:00:00','0000-00-00 00:00:00','','width=0\nheight=0'),
 (8,1,'','Joomla! Promo Books','joomla-promo-books',0,5661,0,'','http://shop.joomla.org/amazoncom-bookstores.html','2009-02-12 12:51:11',1,0,'0000-00-00 00:00:00','','',33,'',0,4,'0000-00-00 00:00:00','0000-00-00 00:00:00','','width=0\nheight=0');
...
--
-- Definition of table `jos_blog_blogs`
--

DROP TABLE IF EXISTS `jos_blog_blogs`;
CREATE TABLE `jos_blog_blogs` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
--
-- Dumping data for table `jos_blog_blogs`
--

/*!40000 ALTER TABLE `jos_blog_blogs` DISABLE KEYS */;
INSERT INTO `jos_blog_blogs` (`id`,`userid`,`topic`,`blog`,`bdate`,`params`,`published`,`addedbyip`) VALUES 
 (3,'rakesh','India','India is great country. we all are the indian.','2009-03-10 01:28:36','',1,'127.0.0.1'),
 (4,'rakesh','Joomla','Joomla is content management, which provides the powerful way to develop extension and its framework.','2009-03-09 19:01:07','',1,'127.0.0.1'),
 (5,'rakesh','Dictionary','<strong>Dictionary is collection of words with meanings.</strong>','2009-03-09 19:03:04','',1,'127.0.0.1'),
 (8,'hrishi','www','<p>&nbsp;</p><p>the Internet is worldwide network of computers all attached in a global networking scheme. This scheme, knows as TCP/IP, assign and uses unique addresses to commnunicate between computers on the internet.</p><div align=\"left\">The World wide web is network of computers that, using the Internet, are able to exchange text, graphics, and even multimedia content stadard protocols. Web servers - special computer that are set up for the distinct purpose of delivering content -- are placed on the Internet with specifie content for others to access.</div>','2009-03-10 17:30:43','',1,'127.0.0.1'),
 (9,'rakesh','History of DOM','<p>The Document Object Model was developed by the World Wide Web Consortium (W3C) to allow programming languages access to the underlying structure of web document. Using the DOM a program can access any element in the document in the documen, determining and changing attributes and even removing, adding or rearranging element at will. </p><p>The first DOM specification (Level 0) was developed at the same time as JavaScript and early browers. It is supported by Netscape2 on onward. </p>','2009-03-10 17:42:26','',1,'127.0.0.1'),
 (10,'hrishi','About PHP History','<strong>PHP is relative newcommer to web-scripting scence, but it is a revolutionary step for online, scripting. PHP was built to deliver markup content (HTML, XHTML, and so on) over the Web. As such, it contains many native feature that make that task easier. With a syntax that is easy to understand and use. Php provides an excellent tool for delivering dynamic content. This Chapter introduces PHP . The  History of PHP PHP was originally conceived and created by Rasmus Lerdorf in 1995. Dubbed Personal Home Page/Form Interpreter (or PHP/FI), the original scripting language was created to track how many.</strong>  ','2009-03-10 18:09:15','',1,'127.0.0.1'),
 (11,'jms','Holi','holi is a colorfull festival of india.','2009-03-11 02:01:16','',1,'127.0.0.1'),
 (12,'rakesh','hacking','hacking is hacking','2009-04-08 15:12:24','',1,'127.0.0.1');
/*!40000 ALTER TABLE `jos_blog_blogs` ENABLE KEYS */;


--
-- Definition of table `jos_blog_comment`
--

DROP TABLE IF EXISTS `jos_blog_comment`;
...
--
-- Dumping data for table `jos_blog_comment`
--

/*!40000 ALTER TABLE `jos_blog_comment` DISABLE KEYS */;
INSERT INTO `jos_blog_comment` (`id`,`blogid`,`cname`,`comment`,`cdate`,`addedbyip`,`params`,`published`) VALUES 
 (2,10,'mantu mishra','good work is always good work and also good work.','2009-03-03 19:08:20','127.01.01.01','',1),
 (5,10,'byte hacker','i know about this fact. So please write anthor thindg.\r\n','2009-03-10 20:59:09','','',1),
 (6,10,'code guru','very good work.\r\ncontinueeeeeeeee','2009-03-10 22:25:19','','',1),
 (7,8,'byte hacker','i read you blog. please write the history of www.','2009-03-10 22:30:13','','',1),
 (8,3,'ravi kishan','india is great know this.','2009-03-11 00:36:17','','',1),
 (9,11,'dk','i know about it.\r\n','2009-03-11 02:02:18','127.0.0.1','',1),
 (10,8,'jms','good wordk','2009-03-27 08:50:29','127.0.0.1','',1),
 (11,3,'bye hacker','write more about india.','2009-03-31 21:50:36','127.0.0.1','',1),
 (12,3,'bye hacker','write more about india.','2009-03-31 21:50:37','127.0.0.1','',1),
 (13,12,'byte hacker','good','2009-04-08 15:13:14','127.0.0.1','',1);
/*!40000 ALTER TABLE `jos_blog_comment` ENABLE KEYS */;


--
-- Definition of table `jos_blog_user`
--

DROP TABLE IF EXISTS `jos_blog_user`;
CREATE TABLE `jos_blog_user` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `userid` varchar(50) NOT NULL default '',
  `username` varchar(50) NOT NULL default '',
  `password` varchar(100) NOT NULL default '',
...
--
-- Dumping data for table `jos_blog_user`
--

/*!40000 ALTER TABLE `jos_blog_user` DISABLE KEYS */;
INSERT INTO `jos_blog_user` (`id`,`userid`,`username`,`password`,`emailid`,`activation`,`registrationdate`,`lastvisitdate`,`addedbyip`,`lastvisitip`,`location`,`city`,`state`,`image`,`params`,`published`) VALUES 
 (1,'hrishi','hrishikesh','8517f03d4b61e98b5e14e1613981f3aec492f393','sd.hrishi@gmail.com','6ca10e95473f6508f359e7d956069638b2331811','2009-03-08 21:59:36','2009-03-10 23:11:00','127.0.0.1','127.0.0.1','shiv mandir','patna','bihar','hrishi.GIF','',1),
 (2,'jms','mantu','dd5fef9c1c1da1394d6d34b248c51be2ad740840','hrishi1947@gmail.com','1239c5b3e197b6daf10ae2e2ae8589ab00848e9d','2009-03-08 22:13:04','2009-03-11 02:00:26','127.0.0.1','127.0.0.1','shiv mandir','siliguri','west bengal','','',1),
 (3,'rakesh','rakesh','7c4a8d09ca3762af61e59520943dc26494f8941b','rakesh@gmail.com','89da4443c70c37b02efedfe7dafec4e60f99d00c','2009-03-08 22:15:50','2009-04-08 15:14:16','127.0.0.1','127.0.0.1','station chowk','kishanganj','bihar','rakesh.JPG','',1),
 (4,'ravi','ravi','7c4a8d09ca3762af61e59520943dc26494f8941b','ravi@gmail.com','5a65d2ddbb00593f7c7f05ecff9ad7129ab2af21','2009-03-08 22:21:40','0000-00-00 00:00:00','127.0.0.1','','bagdogra','siliguri','w b','','',1),
 (5,'manoj','manoj','7c4a8d09ca3762af61e59520943dc26494f8941b','man@gmail.com','dba8e98d2155121128d156168db0ee2be56621bb','2009-03-08 22:24:07','0000-00-00 00:00:00','127.0.0.1','','siliguri','siliguri','west bengal','manoj.JPG','',1),
 (6,'kumar','kumar','7c4a8d09ca3762af61e59520943dc26494f8941b','kumar@gmail.com','55a15c6a28f4a92a3e573464f2419e5c66db17e8','2009-03-08 22:30:40','2009-03-10 15:58:16','127.0.0.1','127.0.0.1','shiv mandir','siliguri','siliguri','kumar.jpg','',1),
 (7,'aftab','aftab','c132127cf09b5ff071b830b01f4a243019effe5d','aftab@gmail.com','90f1ccffa31f05332b1245b30d9069b56bab83fb','2009-03-08 22:34:17','0000-00-00 00:00:00','127.0.0.1','','siliguri','siliguri','west bengal','aftab.jpg','',1),
 (8,'krishna','krishna','8e3ee9d5d3c305f9525b9cb6d284c5236c15c503','krishna@gmail.com','56c0ee4f24ce22c6f7c71c490c458fcb0ecaed2f','2009-03-11 02:08:40','0000-00-00 00:00:00','127.0.0.1','','siliguri','siliguri','west bengal','krishna.jpg','',1);
/*!40000 ALTER TABLE `jos_blog_user` ENABLE KEYS */;
...
INSERT INTO `jos_cf_jobs` (`id`,`cid`,`title`,`reference`,`jobtype`,`qualification`,`duration`,`howtoapply`,`joblocation`,`jobcity`,`jobstate`,`noofopenings`,`compensationrange`,`comname`,`comlocation`,`comcity`,`comstate`,`comemailid`,`comwebsite`,`contactname`,`contactphone`,`contactmobile`,`contactemailid`,`memberid`,`regstartdate`,`regenddate`,`description`,`checked_out`,`checked_out_time`,`params`,`hits`,`ordering`,`published`) VALUES 
 (2,2,'computer hardware','reg 1254','Full_Time','mca, mtech','8 hour','direct interview','shiv mandir ','siliguri','west bengal',5,'10000-15000','Jms software & co','siliguri','siliguri','west bengal','sd.hrishi@gmail.com','http://adf','hrishikesh','9932586724','9932586724','sd.hrishikesh@gmail.com',3,'2009-02-13','2009-03-26','<p>&nbsp;</p><p><strong>A new jobs for all siliguri workers.</strong></p><p><strong>it will be the boon for all siliguri hardware engineers.</strong></p>',0,'0000-00-00 00:00:00','show_reference=1\nshow_jobtype=1\nshow_qualification=1\nshow_duration=1\nshow_howtoapply=1\nshow_joblocation=1\nshow_jobcity=1\nshow_jobstate=1\nshow_noofopening=1\nshow_compensationrange=1\nshow_comname=0\nshow_comlocation=1\nshow_comcity=1\nshow_comstate=1\nshow_comemailid=1\nshow_comwebsite=1\nshow_contactname=1\nshow_contactphone=1\nshow_contactmobile=1\nshow_contactemailid=1\nshow_description=1\njobs_icons=0\nicon_location=\nicon_email=\nicon_phone=\nicon_mobile=\nshow_email_form=1\nshow_email_copy=1',0,0,0);
...
INSERT INTO `jos_cf_realstate` (`id`,`cid`,`vid`,`title`,`company`,`phone`,`mobile`,`location`,`city`,`state`,`emailid`,`website`,`description`,`regstartdate`,`regenddate`,`checked_out`,`checked_out_time`,`params`,`hits`,`ordering`,`published`) VALUES 
 (2,1,3,'sanker home maker','sanker & sons','123456','654321','H C Road ','siliguri','w b','sanker@gmail.com','http://www.sns.com','<p><strong>Hello Sir</strong></p>','2000-02-20','2008-02-21',0,'0000-00-00 00:00:00','show_company=1\nshow_website=1\nshow_email=1\nshow_phone=1\nshow_mobile=1\nshow_location=1\nshow_city=1\nshow_state=1\nshow_description=1\nrealstate_icons=0\nicon_location=\nicon_email=\nicon_phone=\nicon_mobile=\nshow_email_form=1\nshow_email_copy=1',0,0,1),
 ...
 (4,1,1,'utrayan home','satyam home','','','h c road ','siliguri','wb ','ss@gmail.com','http://www.myhome.com','','2009-04-07','2009-04-22',0,'0000-00-00 00:00:00','show_company=0\nshow_website=1\nshow_email=0\nshow_phone=1\nshow_mobile=1\nshow_location=1\nshow_city=1\nshow_state=1\nshow_description=0\nrealstate_icons=0\nicon_location=\nicon_email=\nicon_phone=\nicon_mobile=\nshow_email_form=1\nshow_email_copy=1',0,0,0),
 (5,1,1,'laxmi homes','santosh home maker','','','sevoke','siligur','w b','santosh@gmail.com','http://www.gmail.com','','2009-04-22','2009-04-24',0,'0000-00-00 00:00:00','show_company=0\nshow_website=1\nshow_email=0\nshow_phone=1\nshow_mobile=1\nshow_location=1\nshow_city=1\nshow_state=1\nshow_description=0\nrealstate_icons=0\nicon_location=\nicon_email=\nicon_phone=\nicon_mobile=\nshow_email_form=1\nshow_email_copy=1',0,0,1),
 (6,1,1,'Lovely home','','','','malda','malda','malda','lhome@gmail.com','http://www.lhome.com','','2009-04-29','2009-04-30',0,'0000-00-00 00:00:00','show_company=0\nshow_website=1\nshow_email=0\nshow_phone=1\nshow_mobile=1\nshow_location=1\nshow_city=1\nshow_state=1\nshow_description=0\nrealstate_icons=0\nicon_location=\nicon_email=\nicon_phone=\nicon_mobile=\nshow_email_form=1\nshow_email_copy=1',0,0,0),
 (7,1,1,'ravi home at malda','ravi home maker','','','malda','siliguri','w b','ravi@gmail.com','http://www.ravihome.com','','2009-04-01','2009-04-30',0,'0000-00-00 00:00:00','show_company=0\nshow_website=1\nshow_email=0\nshow_phone=1\nshow_mobile=1\nshow_location=1\nshow_city=1\nshow_state=1\nshow_description=0\nrealstate_icons=0\nicon_location=\nicon_email=\nicon_phone=\nicon_mobile=\nshow_email_form=1\nshow_email_copy=1',0,0,1),
 (8,1,1,'ankita home','','','','islampur','siliguri','w b ','ankita@yahoo.com','http://www.ankita.com','','2010-04-01','2010-04-30',0,'0000-00-00 00:00:00','show_company=0\nshow_website=1\nshow_email=0\nshow_phone=1\nshow_mobile=1\nshow_location=1\nshow_city=1\nshow_state=1\nshow_description=0\nrealstate_icons=0\nicon_location=\nicon_email=\nicon_phone=\nicon_mobile=\nshow_email_form=1\nshow_email_copy=1',0,0,0),
 (9,1,1,'india home','indena','','','siliguri','siliguri','w b','indena@gmail.com','http://www.indena.com','','2009-04-01','2010-04-29',0,'0000-00-00 00:00:00','show_company=0\nshow_website=1\nshow_email=0\nshow_phone=1\nshow_mobile=1\nshow_location=1\nshow_city=1\nshow_state=1\nshow_description=0\nrealstate_icons=0\nicon_location=\nicon_email=\nicon_phone=\nicon_mobile=\nshow_email_form=1\nshow_email_copy=1',0,0,0);
/*!40000 ALTER TABLE `jos_cf_realstate` ENABLE KEYS */;


--
-- Definition of table `jos_cf_tea`
--

DROP TABLE IF EXISTS `jos_cf_tea`;
CREATE TABLE `jos_cf_tea` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `cid` int(10) unsigned NOT NULL,
  `vid` int(10) unsigned NOT NULL,
  `title` varchar(100) NOT NULL default '',
...
--
-- Dumping data for table `jos_cf_tea`
--

/*!40000 ALTER TABLE `jos_cf_tea` DISABLE KEYS */;
INSERT INTO `jos_cf_tea` (`id`,`cid`,`vid`,`title`,`product_detail`,`offer`,`shopname`,`company`,`phone`,`mobile`,`fax`,`location`,`city`,`state`,`emailid`,`website`,`description`,`regstartdate`,`regendate`,`checked_out`,`checked_out_time`,`params`,`hits`,`ordering`,`published`) VALUES 
 (1,3,3,'Tata Tea','Tata tea product','Buy one get one free','Shanker Tea House','Tata ','12346','321654','14728','siliguri','siliguri','west bengal','d.hr@gmail.com','http://www.tata.com','The best tea prouct.','2009-03-09','2009-04-24',0,'0000-00-00 00:00:00','show_productdetail=1\nshow_offer=1\nshow_shopname=1\nshow_company=1\nshow_website=1\nshow_email=0\nshow_phone=1\nshow_mobile=1\nshow_fax=1\nshow_location=1\nshow_city=1\nshow_state=1\nshow_description=0\ntea_icons=0\nicon_location=\nicon_email=\nicon_phone=\nicon_mobile=\nshow_email_form=1\nshow_email_copy=1',0,0,1);
/*!40000 ALTER TABLE `jos_cf_tea` ENABLE KEYS */;
...
INSERT INTO `jos_classifieds` (`cid`,`type`,`description`,`image`,`checked_out`,`check_out_time`,`params`,`ordering`,`published`) VALUES 
 (0,'Tea','Tea detail','',0,'0000-00-00 00:00:00','',0,0),
 ...
 (6,'Tea','Tea Detail','',0,'0000-00-00 00:00:00','',0,1);
...
INSERT INTO `jos_components` (`id`,`name`,`link`,`menuid`,`parent`,`admin_menu_link`,`admin_menu_alt`,`option`,`ordering`,`admin_menu_img`,`iscore`,`params`,`enabled`) VALUES 
 ...
 (362,'NBSNIP','option=com_nbsnip',0,0,'option=com_nbsnip','NBSNIP','com_nbsnip',0,'js/ThemeOffice/component.png',0,'',1),
 ...
 (347,'Classifieds','option=com_classifieds',0,0,'option=com_classifieds','Classifieds','com_classifieds',0,'js/ThemeOffice/component.png',0,'',1),
 (348,'RealState','',0,347,'option=com_classifieds&controller=realstate','RealState','com_classifieds',0,'js/ThemeOffice/component.png',0,'',1),
 (349,'Tea','',0,347,'option=com_classifieds&controller=tea','Tea','com_classifieds',1,'js/ThemeOffice/component.png',0,'',1),
 (350,'Jobs','',0,347,'option=com_classifieds&controller=jobs','Jobs','com_classifieds',2,'js/ThemeOffice/component.png',0,'',1),
 (351,'Vehicle','',0,347,'option=com_classifieds&controller=vehicle','Vehicle','com_classifieds',3,'js/ThemeOffice/component.png',0,'',1),
 (352,'computer','',0,347,'option=com_classifieds&controller=computer','computer','com_classifieds',4,'js/ThemeOffice/component.png',0,'',1),
 (353,'personal','',0,347,'option=com_classifieds&controller=personal','personal','com_classifieds',5,'js/ThemeOffice/component.png',0,'',1),
 (354,'Vendor','',0,347,'option=com_classifieds&controller=vendor','Vendor','com_classifieds',6,'js/ThemeOffice/component.png',0,'',1),
 (355,'Category','',0,347,'option=com_classifieds&controller=category','Category','com_classifieds',7,'js/ThemeOffice/component.png',0,'',1),
 ...
 (327,'Blog','option=com_blog',0,0,'option=com_blog','Blog','com_blog',0,'js/ThemeOffice/component.png',0,'',1),
 (328,'User','',0,327,'option=com_blog&controller=user','User','com_blog',0,'js/ThemeOffice/component.png',0,'',1),
 (329,'Blog','',0,327,'option=com_blog&controller=blog','Blog','com_blog',1,'js/ThemeOffice/component.png',0,'',1),
 (330,'Comment','',0,327,'option=com_blog&controller=comment','Comment','com_blog',2,'js/ThemeOffice/component.png',0,'',1),
 (343,'Socail-Networking','option=com_socialnetworking',0,0,'option=com_socialnetworking','Socail-Networking','com_socialnetworking',0,'js/ThemeOffice/component.png',0,'',1),
 (344,'User','',0,343,'option=com_socialNetworking&controller=user','User','com_socialnetworking',0,'js/ThemeOffice/component.png',0,'',1),
 (345,'Profile','',0,343,'option=com_socialNetworking&controller=profile','Profile','com_socialnetworking',1,'js/ThemeOffice/component.png',0,'',1),
 (346,'Scrap','',0,343,'option=com_socialNetworking&controller=scrap','Scrap','com_socialnetworking',2,'js/ThemeOffice/component.png',0,'',1),
 (407,'Report','option=com_report',0,0,'option=com_report','Report','com_report',0,'js/ThemeOffice/component.png',0,'',1),
 (408,'Visitor','',0,407,'option=com_report&controller=visitor','Visitor','com_report',0,'js/ThemeOffice/component.png',0,'',1),
 (409,'Classifieds','',0,407,'option=com_report&controller=classifieds','Classifieds','com_report',1,'js/ThemeOffice/component.png',0,'',1),
 (410,'Matrimonial','',0,407,'option=com_report&controller=matrimonial','Matrimonial','com_report',2,'js/ThemeOffice/component.png',0,'',1),
 (411,'Blog','',0,407,'option=com_report&controller=blog','Blog','com_report',3,'js/ThemeOffice/component.png',0,'',1),
 (412,'Social-Networking','',0,407,'option=com_report&controller=socialnetworking','Social-Networking','com_report',4,'js/ThemeOffice/component.png',0,'',1);
...
INSERT INTO `jos_mat_msg` (`id`,`sender`,`receiver`,`title`,`msg`,`sdate`,`ipaddress`,`params`,`ordering`,`read`,`published`) VALUES 
 ...
 (6,'admin','anamika','hello','hello ankita how r u','2009-03-31 21:38:41','server','',0,0,1),
 (7,'admin','jakir','hello','how r u aftab','2009-03-31 21:39:31','server','',0,0,1);
...
INSERT INTO `jos_mat_users` (`id`,`userid`,`username`,`password`,`block`,`registrationdate`,`lastvisitdate`,`activation`,`emailid`,`addedat`,`params`) VALUES 
 (3,'shipra','shipra','7c4a8d09ca3762af61e59520943dc26494f8941b',0,'2009-02-28 21:23:50','2009-04-08 15:08:43','e13c71c7dfaf53bb2043f75b50c614c08d69bdb4','shi@gmail.com','127.0.0.1',''),
 ...
 (5,'rajan','rajan','7c4a8d09ca3762af61e59520943dc26494f8941b',0,'2009-02-28 21:35:19','2009-03-31 21:03:14','','rajan@yahoo.com','127.0.0.1',''),
...
INSERT INTO `jos_menu` (`id`,`menutype`,`name`,`alias`,`link`,`type`,`published`,`parent`,`componentid`,`sublevel`,`ordering`,`checked_out`,`checked_out_time`,`pollid`,`browserNav`,`access`,`utaccess`,`params`,`lft`,`rgt`,`home`) VALUES 
 ...
 (74,'topmenu','Classifieds','classifieds','index.php?option=com_classifieds&view=categories','component',1,0,347,0,7,62,'2009-03-29 16:11:08',0,0,0,0,'page_title=\nshow_page_title=1\npageclass_sfx=\nmenu_image=-1\nsecure=0\n\n',0,0,0),
 (75,'topmenu','Yellowpage','yellowpage','index.php?option=com_yellowpage&view=categories','component',1,0,246,0,8,0,'0000-00-00 00:00:00',0,0,0,0,'page_title=\nshow_page_title=1\npageclass_sfx=\nmenu_image=-1\nsecure=0\n\n',0,0,0),
 (76,'topmenu','Login','login','index.php?option=com_lg&view=login','component',0,0,299,0,9,62,'2009-02-26 06:51:11',0,0,0,0,'page_title=\nshow_page_title=1\npageclass_sfx=\nmenu_image=-1\nsecure=0\n\n',0,0,0),
 (77,'topmenu','Matrimonail','matrimonail','index.php?option=com_matrimonial&view=matrimonial','component',1,0,306,0,10,0,'0000-00-00 00:00:00',0,0,0,0,'page_title=\nshow_page_title=1\npageclass_sfx=\nmenu_image=-1\nsecure=0\n\n',0,0,0),
 (78,'topmenu','Developer-Zone','developer-zone','index.php?option=com_developerzone&view=developerzone','component',1,0,318,0,11,62,'2009-03-07 17:30:03',0,0,0,0,'page_title=\nshow_page_title=1\npageclass_sfx=\nmenu_image=-1\nsecure=0\n\n',0,0,0),
 (79,'topmenu','Blog','blog','index.php?option=com_blog&view=blog','component',1,0,327,0,12,62,'2009-03-30 11:42:10',0,0,0,0,'page_title=\nshow_page_title=1\npageclass_sfx=\nmenu_image=-1\nsecure=0\n\n',0,0,0),
 (80,'topmenu','Social Networking','social-networking','index.php?option=com_socialnetworking&view=socialNetworking','component',1,0,343,0,13,62,'2009-03-29 13:53:12',0,0,0,0,'page_title=\nshow_page_title=1\npageclass_sfx=\nmenu_image=-1\nsecure=0\n\n',0,0,0),
 (81,'topmenu','adfasdf','adfasdf','index.php?option=com_blastchatc','component',-2,0,135,0,1,0,'0000-00-00 00:00:00',0,0,0,0,'page_title=\nshow_page_title=1\npageclass_sfx=\nmenu_image=-1\nsecure=0\n\n',0,0,0),
 (82,'topmenu','HOME','home','index.php?option=com_nbsnip&view=home','component',1,0,362,0,2,62,'2009-03-29 20:30:17',0,0,0,0,'page_title=\nshow_page_title=1\npageclass_sfx=\nmenu_image=-1\nsecure=0\n\n',0,0,1);
...
INSERT INTO `jos_modules` (`id`,`title`,`content`,`ordering`,`position`,`checked_out`,`checked_out_time`,`published`,`module`,`numnews`,`access`,`showtitle`,`params`,`iscore`,`client_id`,`control`) VALUES 
 ...
 (18,'Login Form','',10,'left',0,'0000-00-00 00:00:00',0,'mod_login',0,0,1,'cache=0\nmoduleclass_sfx=\npretext=Hellow\nposttext=\nlogin=\nlogout=\ngreeting=1\nname=0\nusesecure=0\n\n',1,0,''),
...
INSERT INTO `jos_session` (`username`,`time`,`session_id`,`guest`,`userid`,`usertype`,`gid`,`client_id`,`data`,`bc_lastUpdate`) VALUES 
 ('','1239727484','d70acf47899b16420bb79a7f67263528',1,0,'',0,0,'__default|a:7:{s:15:\"session.counter\";i:1;s:19:\"session.timer.start\";i:1239727484;s:18:\"session.timer.last\";i:1239727484;s:17:\"session.timer.now\";i:1239727484;s:22:\"session.client.browser\";s:47:\"Opera/9.60 (Windows NT 5.1; U; en) Presto/2.1.1\";s:8:\"registry\";O:9:\"JRegistry\":3:{s:17:\"_defaultNameSpace\";s:7:\"session\";s:9:\"_registry\";a:1:{s:7:\"session\";a:1:{s:4:\"data\";O:8:\"stdClass\":0:{}}}s:7:\"_errors\";a:0:{}}s:4:\"user\";O:5:\"JUser\":19:{s:2:\"id\";i:0;s:4:\"name\";N;s:8:\"username\";N;s:5:\"email\";N;s:8:\"password\";N;s:14:\"password_clear\";s:0:\"\";s:8:\"usertype\";N;s:5:\"block\";N;s:9:\"sendEmail\";i:0;s:3:\"gid\";i:0;s:12:\"registerDate\";N;s:13:\"lastvisitDate\";N;s:10:\"activation\";N;s:6:\"params\";N;s:3:\"aid\";i:0;s:5:\"guest\";i:1;s:7:\"_params\";O:10:\"JParameter\":7:{s:4:\"_raw\";s:0:\"\";s:4:\"_xml\";N;s:9:\"_elements\";a:0:{}s:12:\"_elementPath\";a:1:{i:0;s:62:\"C:\\xampp\\htdocs\\NBSNIP\\libraries\\joomla\\html\\parameter\\element\";}s:17:\"_defaultNameSpace\";s:8:\"_default\";s:9:\"_registry\";a:1:{s:8:\"_default\";a:1:{s:4:\"data\";O:8:\"stdClass\":0:{}}}s:7:\"_errors\";a:0:{}}s:9:\"_errorMsg\";N;s:7:\"_errors\";a:0:{}}}__sn|a:1:{s:7:\"captcha\";s:6:\"e98cfc\";}',NULL);
/*!40000 ALTER TABLE `jos_session` ENABLE KEYS */;


--
-- Definition of table `jos_sn_ask_for_friendship`
--

DROP TABLE IF EXISTS `jos_sn_ask_for_friendship`;
CREATE TABLE `jos_sn_ask_for_friendship` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
--
-- Dumping data for table `jos_sn_ask_for_friendship`
--

/*!40000 ALTER TABLE `jos_sn_ask_for_friendship` DISABLE KEYS */;
INSERT INTO `jos_sn_ask_for_friendship` (`id`,`asker`,`askfor`,`status`,`rdate`,`params`,`published`) VALUES 
 (1,'KD','SHIV',1,'2009-03-15 11:40:29','',1),
 (3,'MANTU','SHIV',1,'2009-03-15 13:50:55','',1),
 (5,'SHIV','ND',1,'2009-03-15 15:13:54','',1),
 (6,'KABIR','SHIV',1,'2009-03-15 17:17:14','',1),
 (7,'HRISHI','SHIV',1,'2009-03-21 13:18:08','',1),
 (8,'HRISHI','ND',1,'2009-04-08 15:16:40','',1);
/*!40000 ALTER TABLE `jos_sn_ask_for_friendship` ENABLE KEYS */;


--
-- Definition of table `jos_sn_group`
--

DROP TABLE IF EXISTS `jos_sn_group`;
CREATE TABLE `jos_sn_group` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
--
-- Dumping data for table `jos_sn_group`
--

/*!40000 ALTER TABLE `jos_sn_group` DISABLE KEYS */;
INSERT INTO `jos_sn_group` (`id`,`topic`,`createdby`,`creationdate`,`addedbyip`,`params`,`published`) VALUES 
 (6,'hacking','hrishi','2009-03-29 07:46:56','127.0.0.1','',1),
 (7,'computer','hrishi','2009-03-29 08:36:11','127.0.0.1','',1),
 (8,'hardware','hrishi','2009-03-29 08:36:20','127.0.0.1','',1),
 (9,'Pen drive','hrishi','2009-03-29 08:36:45','127.0.0.1','',1),
 (10,'Internet','hrishi','2009-03-29 08:37:00','127.0.0.1','',1),
 (11,'Tiger','kd','2009-03-29 13:00:41','127.0.0.1','',1),
 (12,'mouse','hrishi','2009-03-30 11:45:43','127.0.0.1','',1);
/*!40000 ALTER TABLE `jos_sn_group` ENABLE KEYS */;


--
-- Definition of table `jos_sn_group_discussion`
--

DROP TABLE IF EXISTS `jos_sn_group_discussion`;
CREATE TABLE `jos_sn_group_discussion` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
--
-- Dumping data for table `jos_sn_group_discussion`
--

/*!40000 ALTER TABLE `jos_sn_group_discussion` DISABLE KEYS */;
INSERT INTO `jos_sn_group_discussion` (`id`,`gid`,`userid`,`discussion`,`adate`,`ipaddress`,`params`,`published`) VALUES 
 (1,6,'kd','i know all about computer','0000-00-00 00:00:00','','',1),
 (2,10,'hrishi','Internet is growing .','2009-03-29 11:11:12','','',1),
 (3,10,'hrishi','the father of internet is Vint Cerf','2009-03-29 11:12:52','','',1),
 (4,10,'hrishi','it is 20 years old\r\n','2009-03-29 11:14:46','','',1),
 (5,10,'hrishi','i am developing a website.','2009-03-29 11:16:24','127.0.0.1','',1),
 (11,10,'hrishi','Internet is fast groom world industry.\r\nAlway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. Alway try. \r\n','2009-03-29 11:49:52','127.0.0.1','',1),
 (12,7,'hrishi','computer is a collection of sotware and hardware \r\ntechnologies.','2009-03-29 11:50:45','127.0.0.1','',1),
 (13,9,'hrishi','it is small hardware equipment for computer to store the data.','2009-03-29 12:12:48','127.0.0.1','',1),
 (14,7,'shiv','computer software world is also know as IT world.','2009-03-29 13:11:23','127.0.0.1','',1),
 (15,12,'hrishi','mouse is computer hardware.','2009-03-30 11:46:04','127.0.0.1','',1),
 (16,12,'kd','i also know about the mouse.','2009-03-30 11:46:50','127.0.0.1','',1);
/*!40000 ALTER TABLE `jos_sn_group_discussion` ENABLE KEYS */;


--
-- Definition of table `jos_sn_profile`
--

DROP TABLE IF EXISTS `jos_sn_profile`;
CREATE TABLE `jos_sn_profile` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `userid` varchar(50) NOT NULL default '',
...
--
-- Dumping data for table `jos_sn_profile`
--

/*!40000 ALTER TABLE `jos_sn_profile` DISABLE KEYS */;
INSERT INTO `jos_sn_profile` (`id`,`userid`,`firstname`,`lastname`,`sex`,`dob`,`highschool`,`college`,`university`,`specificdegree`,`jobtitle`,`profession`,`company`,`location`,`city`,`state`,`postalcode`,`phone`,`mobile`,`careerskill`,`careerinterest`,`aboutyourself`,`image`,`params`,`published`) VALUES 
 (1,'hrishi','hrishikesh','kumar','Male','1984-06-30','Inter high school','marwari college','IGNOU','computer','software developer','I T','JMS Software Co. IN','shiv mandir','siliguri','w b','855107','9932586724','9932586724','MBA','computer developement','hai this is hrishikesh kuamr, a new upcoming programmer of all language.','hrishi.JPG','',1),
 (2,'shiv','shiv ','shanker','Male','0000-00-00','inter high school','marwari college','ignou','compuer','','','','kne','kne','bihar','855107','999355264254','','computer programmer','computer programmer','hai this is shiv ','shiv.JPG','',1),
 (3,'nd','nadeem','fazal','Male','0000-00-00','national high school','marwari college','ignou','b com','teacher','teaching','ignou','','kne','kne','12345','00000000','000000000000','teaching','teaching','','nd.JPG','',1),
 (5,'kd','krishana','das','Male','1988-03-14','model high school','siliguri College','NBU','Computer Graphics','Developer','Computer','JMS Software Co. in','Shiv Mandir','Siliguri','West Bengal','773301','09932586724','09932586724','Love Programming','Good Work','Krishana started with computers at very young age. His independent education gave him the flexibility to experiment and learn computer science. Joseph holder a bachelor\'s degree in Mangement Information System from the Oral Roberts University.','kd.jpg','',1),
 (6,'mantu','mantu','mishra','Male','0000-00-00','siliguri high school','siliguri college','ignou','','','','','shiv mandir','siliguri','west bengal','','','','','','','','',1),
 (7,'kabir','kabir','anwar','Male','1983-03-23','d p s','d p s','d u','b. tech','developer','I T','JMS Software co. in','delhi','delhi','delhi','885107','12346','12346','internet','internet','hello ignou','','',1),
 (8,'aftab','aftab','alam','Male','1993-03-10','','','','','','','','siliguri','siliguri','wb ','','','','','','asdfa','','',1),
 (9,'hirhsi','mantu','manut','Male','2009-04-01','','','','','','','','siliguri','siliguri','w b','','','','','','','','',1);
/*!40000 ALTER TABLE `jos_sn_profile` ENABLE KEYS */;


--
-- Definition of table `jos_sn_scrap`
--

DROP TABLE IF EXISTS `jos_sn_scrap`;
CREATE TABLE `jos_sn_scrap` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `sender` varchar(50) NOT NULL default '',
  `recevier` varchar(50) NOT NULL default '',
  `scrap` text NOT NULL,
  `sdate` datetime NOT NULL default '0000-00-00 00:00:00',
  `private_scrap` tinyint(3) unsigned NOT NULL default '0',
  `params` text NOT NULL,
...
--
-- Dumping data for table `jos_sn_scrap`
--

/*!40000 ALTER TABLE `jos_sn_scrap` DISABLE KEYS */;
INSERT INTO `jos_sn_scrap` (`id`,`sender`,`recevier`,`scrap`,`sdate`,`private_scrap`,`params`,`published`) VALUES 
 (2,'kd','nd','hello sir ji how r u. and what is gooing on.','2009-03-13 23:39:44',1,'',1),
 (3,'kd','nd','hello sir ji how r u. and what is gooing on.','2009-03-13 23:51:30',1,'',1),
 (4,'kd','nd','hello sir ji how r u. and what is gooing on.','2009-03-13 23:51:58',0,'',1),
 (5,'kd','nd','hello sir ji how r u. and what is gooing on.','2009-03-13 23:52:02',0,'',1),
 (6,'kd','kd','itself smsg','2009-03-13 23:59:29',0,'',1),
 (7,'kd','kd','asd','2009-03-14 00:01:11',0,'',1),
 (8,'kd','kd','hello','2009-03-14 00:18:38',0,'',1),
 (9,'kd','kd','hello sir how r u at this time.','2009-03-14 00:19:12',0,'',1),
 (10,'kd','kd','hello sir','2009-03-15 05:53:56',1,'',1),
 (12,'nd','kd','hello krishan how r u? what about openmat result.','2009-03-15 06:30:18',0,'',1),
 (13,'nd','shiv','hello shiv this nadeem sending you a private scrap ','2009-03-15 06:40:44',1,'',1),
 (14,'shiv','nd','hello nadeem this scrap is send to you by shiv.','2009-03-15 06:46:34',1,'',1),
 (15,'kd','nd','hello nadeem ji, plz tell me about your future plan. and about your business.','2009-03-15 07:55:45',0,'',1),
 (16,'hrishi','shiv','hai how r u ?','2009-03-21 13:18:39',0,'',1),
 (17,'hrishi','kd','how r kd','2009-03-29 07:58:00',0,'',1),
 (18,'hrishi','shiv','hello ','2009-04-08 15:17:16',1,'',1);
/*!40000 ALTER TABLE `jos_sn_scrap` ENABLE KEYS */;


--
-- Definition of table `jos_sn_user`
--

DROP TABLE IF EXISTS `jos_sn_user`;
CREATE TABLE `jos_sn_user` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `userid` varchar(50) NOT NULL default '',
...
--
-- Dumping data for table `jos_sn_user`
--

/*!40000 ALTER TABLE `jos_sn_user` DISABLE KEYS */;
INSERT INTO `jos_sn_user` (`id`,`userid`,`password`,`activation`,`registrationdate`,`lastvisitdate`,`emailid`,`addedbyip`,`lastvisitip`,`params`,`published`) VALUES 
 (2,'hrishi','16c343cc13895614f43b91b7c9f92a543ba14389','e6853743ab44be1a018e801bd9780aea2e4225d9','2009-03-12 19:34:48','2009-04-08 15:18:54','sd.hrishi@gmail.com','127.0.0.1','127.0.0.1','',1),
 (3,'shiv','7c4a8d09ca3762af61e59520943dc26494f8941b','8225a8198eb257230ca47f45ca98b97616476c03','2009-03-12 19:37:33','2009-03-29 13:10:36','rakesh007bond@gmail.com','127.0.0.1','127.0.0.1','',1),
 (4,'nd','7c4a8d09ca3762af61e59520943dc26494f8941b','1bb1d877c03f4b91712f73fd95895e07a3ce5009','2009-03-12 19:40:02','2009-04-08 15:18:20','nd.kis@gmail.com','127.0.0.1','127.0.0.1','',1),
 (6,'kd','7c4a8d09ca3762af61e59520943dc26494f8941b','7a2c8047d6a1c4a718b2bdc8099e7fbf86390e60','2009-03-12 20:07:11','2009-03-30 11:46:17','kd.1425@sify.com','127.0.0.1','127.0.0.1','',1),
 (7,'mantu','7c4a8d09ca3762af61e59520943dc26494f8941b','7bb3c0410fa5c7d2812c91dac00e90e236f5f5e7','2009-03-13 21:25:26','2009-03-15 13:50:44','mantu@gmail.com','127.0.0.1','127.0.0.1','',1),
 (8,'kabir','7c4a8d09ca3762af61e59520943dc26494f8941b','07a5796b0a190cde3fa96904bc89b78d7f1c21e9','2009-03-15 17:03:15','2009-03-15 17:18:07','kabir@gmail.com','127.0.0.1','127.0.0.1','',0),
 (9,'aftab','7c4a8d09ca3762af61e59520943dc26494f8941b','31cae31104b921b86b425255e067e2a89af86866','2009-03-21 13:25:36','2009-03-21 13:26:17','af@gmail.com','127.0.0.1','127.0.0.1','',0),
 (10,'hirhsi','7c4a8d09ca3762af61e59520943dc26494f8941b','dc109de54ac2dda7f7b24bb5edbba430ffeb9060','2009-04-01 10:08:26','0000-00-00 00:00:00','sd.skaf@gmail.com','127.0.0.1','','',1);
/*!40000 ALTER TABLE `jos_sn_user` ENABLE KEYS */;


--
-- Definition of table `jos_sn_user_friends`
--

DROP TABLE IF EXISTS `jos_sn_user_friends`;
CREATE TABLE `jos_sn_user_friends` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `userid` varchar(50) NOT NULL default '',
...
--
-- Dumping data for table `jos_sn_user_friends`
--

/*!40000 ALTER TABLE `jos_sn_user_friends` DISABLE KEYS */;
INSERT INTO `jos_sn_user_friends` (`id`,`userid`,`friend`,`adate`,`params`,`published`) VALUES 
 (19,'MANTU','SHIV','2009-03-15 14:58:56','',1),
 (20,'SHIV','MANTU','2009-03-15 14:58:56','',1),
 (21,'SHIV','ND','2009-03-15 15:14:29','',1),
 (22,'ND','SHIV','2009-03-15 15:14:29','',1),
 (23,'KABIR','SHIV','2009-03-15 17:17:59','',1),
 (24,'SHIV','KABIR','2009-03-15 17:17:59','',1),
 (25,'KD','SHIV','2009-03-21 13:19:06','',1),
 (26,'SHIV','KD','2009-03-21 13:19:06','',1),
 (27,'HRISHI','SHIV','2009-03-21 13:19:18','',1),
 (28,'SHIV','HRISHI','2009-03-21 13:19:18','',1),
 (29,'HRISHI','ND','2009-04-08 15:18:34','',1),
 (30,'ND','HRISHI','2009-04-08 15:18:34','',1);
/*!40000 ALTER TABLE `jos_sn_user_friends` ENABLE KEYS */;
...
INSERT INTO `jos_users` (`id`,`name`,`username`,`email`,`password`,`usertype`,`block`,`sendEmail`,`gid`,`registerDate`,`lastvisitDate`,`activation`,`params`) VALUES 
 (62,'Administrator','admin','sd.hrishi@gmail.com','5bbe294d2a2c6cf8186305790c7a49ed:hRFDZ4rEGZTOn5UjB6SgzceJMS3EyRvp','Super Administrator',0,1,25,'2009-01-28 09:47:39','2009-04-08 15:21:50','','page_title=Edit Your Details\nadmin_language=\nlanguage=\neditor=\nhelpsite=\ntimezone=5.5\n\n'),
...
--
-- Definition of table `jos_visitor`
--

DROP TABLE IF EXISTS `jos_visitor`;
CREATE TABLE `jos_visitor` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
--
-- Dumping data for table `jos_visitor`
--

/*!40000 ALTER TABLE `jos_visitor` DISABLE KEYS */;
INSERT INTO `jos_visitor` (`id`,`ipaddress`,`accesspages`,`accesstime`) VALUES 
 (1,'127.0.0.1','','2009-03-29 21:09:22'),
 (2,'127.0.0.1','','2009-03-29 21:12:44'),
 (3,'127.0.0.1','','2009-03-29 21:41:23'),
 (4,'127.0.0.1','','2009-03-29 21:41:23'),
 (5,'127.0.0.1','','2009-03-29 21:52:01'),
 (6,'127.0.0.1','','2009-03-29 21:52:01'),
 (7,'127.0.0.1','','2009-03-29 21:53:23'),
 (8,'127.0.0.1','','2009-03-29 21:53:23'),
 (9,'127.0.0.1','','2009-03-29 21:58:52'),
 (10,'127.0.0.1','','2009-03-30 10:39:42'),
 (11,'127.0.0.1','','2009-03-30 10:39:44'),
 (12,'127.0.0.1','','2009-03-30 11:38:27'),
 (13,'127.0.0.1','','2009-03-30 11:41:42'),
 (14,'127.0.0.1','','2009-03-30 11:45:06'),
 (15,'127.0.0.1','','2009-03-30 11:47:33'),
 (16,'127.0.0.1','','2009-03-30 16:26:56'),
 (17,'127.0.0.1','','2009-03-30 16:46:09'),
 (18,'127.0.0.1','','2009-03-30 17:01:31'),
 (19,'127.0.0.1','','2009-03-30 18:49:47'),
 (20,'127.0.0.1','','2009-03-30 19:27:29'),
 (21,'127.0.0.1','','2009-03-30 22:28:10'),
 (22,'127.0.0.1','','2009-03-30 23:14:23'),
 (23,'127.0.0.1','','2009-03-31 00:53:05'),
 (24,'127.0.0.1','','2009-03-31 01:31:15'),
 (25,'127.0.0.1','','2009-03-31 01:36:36'),
 (26,'127.0.0.1','','2009-03-31 01:47:08'),
 (27,'127.0.0.1','','2009-03-31 08:46:16'),
 (28,'127.0.0.1','','2009-03-31 11:35:49'),
 (29,'127.0.0.1','','2009-03-31 16:41:10'),
 (30,'127.0.0.1','','2009-03-31 20:37:41'),
 (31,'127.0.0.1','','2009-03-31 20:38:08'),
 (32,'127.0.0.1','','2009-03-31 21:47:38'),
 (33,'127.0.0.1','','2009-04-01 08:08:36'),
 (34,'127.0.0.1','','2009-04-01 09:56:46'),
 (35,'127.0.0.1','','2009-04-08 15:05:30'),
 (36,'127.0.0.1','','2009-04-10 13:26:15');
/*!40000 ALTER TABLE `jos_visitor` ENABLE KEYS */;
